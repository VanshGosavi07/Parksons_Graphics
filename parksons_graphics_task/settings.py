...
# For production (PythonAnywhere)
    ...
    SECRET_KEY = "4AGfe2H7tmNwa7ZASc6ashaUuc7WfAOVgOtQVjoJXMkvXCba0AaszFJ-NGYzF1XztfU"

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'dsa07.pythonanywhere.com']  # PythonAnywhere domain
